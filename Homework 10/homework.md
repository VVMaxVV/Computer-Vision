...
### Answers
I would like give 1 answer on both question. Yes, CSRT barely changes the detection zone size, unlike other algorithms. MIL performs much worse with smaller zones and often loses them. Each of them is suitable for its own tasks.